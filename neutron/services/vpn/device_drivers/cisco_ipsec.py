...
CONF.register_opts(ipsec_opts, 'cisco_csr_ipsec')
    ...
    def update_service(self, context, service_data):
        ...
        if vpn_service_id in self.service_state:
            ...
            if is_admin_up:
                ...
                LOG.debug(_("Update: VPN service %s is admin down - "
                            "marked dirty"), vpn_service_id)
                return vpn_service
        else:
            if not is_admin_up:
