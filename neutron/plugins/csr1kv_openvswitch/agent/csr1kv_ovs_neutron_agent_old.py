...
from neutron.extensions import trunkport
...
class CSR1kvOVSNeutronAgent(sg_rpc.SecurityGroupAgentRpcCallbackMixin):
    ...
    def __init__(self, integ_br, tun_br, local_ip,
        ...
        self.available_local_vlans = set(
            xrange(CSR1kvOVSNeutronAgent.MIN_VLAN_TAG,
                   CSR1kvOVSNeutronAgent.MAX_VLAN_TAG))
        ...
        self.agent_state = {
            'binary': 'neutron-csr1kv-openvswitch-agent',
            'host': cfg.CONF.host,
...
def main():
    ...
    plugin = CSR1kvOVSNeutronAgent(**agent_config)
