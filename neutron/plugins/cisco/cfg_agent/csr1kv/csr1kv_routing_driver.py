...
from neutron.plugins.cisco.cfg_agent.cfg_exceptions import (
    CSR1kvConfigException, CSR1kvConnectionException,
    CSR1kvInitializationException)
...
class CSR1kvRoutingDriver(RoutingDriverBase):
    ...
    def __init__(self, **device_params):
        try:
            ...
            raise CSR1kvInitializationException
    ...
    def _get_connection(self):
        ...
        try:
            ...
            raise CSR1kvConnectionException(**conn_params)
    ...
    def _check_response(self, rpc_obj, snippet_name):
        ...
        raise CSR1kvConfigException(**params)
