...
class TypeManager(stevedore.named.NamedExtensionManager):
    ...
    def get_segments(self, context, network_id):
        ...
        for segment in segments:
            driver = self.drivers.get(segment.segment_type)
            one_segment = driver.obj.get_segment(context, network_id)
            if one_segment:
                one_segment['id'] = segment['id']
                return_segments.append(one_segment)
