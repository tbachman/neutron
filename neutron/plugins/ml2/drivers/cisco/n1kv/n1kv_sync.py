...
from neutron.plugins.ml2.drivers.cisco.n1kv import config
...
class N1kvSyncDriver():
    ...
    def __init__(self, db_base_plugin_obj):
        ...
        # restart
        self.sync_bds = {vsm_ip: True for vsm_ip in config.get_vsm_hosts()}
        self.bd_names = set()
    ...
    def _sync_delete_subnets(self, combined_res_info, vsm_ip):
        ...
        (vsm_subnet_uuids, neutron_subnets) = combined_res_info
        neutron_subnet_uuids = set(self._get_uuids(
