...
class VPNPluginDb(vpnaas.VPNPluginBase, base_db.CommonDbMixin):
    ...
    def _get_subnet_version(self, context, vpnservice_id):
    ...
    def create_ipsec_site_connection(self, context, ipsec_site_connection):
        ...
        with context.session.begin(subtransactions=True):
            ...
            ip_version = self._get_subnet_version(context, vpnservice_id)
    ...
    def update_ipsec_site_connection(
        ...
        isec_sitecon = ipsec_site_connection['ipsec_site_connection']
        ...
        with context.session.begin(subtransactions=True):
            ...
            if "peer_cidrs" in isec_sitecon:
                ...
                new_peer_cidr_set = set(isec_sitecon["peer_cidrs"])
                ...
                del isec_sitecon["peer_cidrs"]
            if isec_sitecon:
                ipsec_site_conn_db.update(isec_sitecon)
