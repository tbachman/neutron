...
class TestCiscoCsrIPsecDeviceDriverConfigLoading(base.BaseTestCase):
    ...
    def test_loading_csr_configuration(self):
        ...
        cfg_file = self.create_tempfile('[CISCO_CSR_REST:3.2.1.0]\n'
    ...
    def test_fail_loading_config_with_invalid_subnet(self):
        """Failure test of config with invalid subnet."""
        cfg_file = self.create_tempfile('[CISCO_CSR_REST:4.3.2.1.0]\n'
                                        'rest_mgmt = 10.20.30.1\n'
                                        'username = me\n'
                                        'password = secret\n'
                                        'timeout = 5.0\n')
