...
from quantum.plugins.csr1kv_openvswitch.common import config
from quantum.plugins.csr1kv_openvswitch.common import constants
from quantum.plugins.csr1kv_openvswitch.extensions import trunkport
...
class CSR1kv_OVSQuantumPluginV2(db_base_plugin_v2.QuantumDbPluginV2,
    ...
    def __init__(self, configfile=None):
        ...
        if self.enable_tunneling:
            ...
            sys.exit(1)
        self.setup_rpc()
        self._plugin = cl3_constants.OVS_PLUGIN
    ...
    def get_port(self, context, id, fields=None):
        with context.session.begin(subtransactions=True):
            port = super(CSR1kv_OVSQuantumPluginV2, self).get_port(context,
                                                                   id, fields)
            self._extend_port_dict_security_group(context, port)
    ...
    def get_ports(self, context, filters=None, fields=None,
                  ...
                  page_reverse=False):
        with context.session.begin(subtransactions=True):
            ports = super(CSR1kv_OVSQuantumPluginV2, self).get_ports(
